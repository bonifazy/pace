...
next_competiotions = types.InlineKeyboardButton(text='/comps', callback_data='menu_competitions')
next_step_keyboard.row(next_interval, next_tempo, next_long, next_competiotions)
...
distance_training_500m = types.InlineKeyboardButton(text='500 м.', callback_data='distance_training_500m')
distance_training_600m = types.InlineKeyboardButton(text='600 м.', callback_data='distance_training_600m')
